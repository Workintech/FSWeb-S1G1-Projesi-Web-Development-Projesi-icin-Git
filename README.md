...
- [x] Aşağıdaki adımları takip ederk; - [x] 1- bilgisayarında değiştirdiğin dosyayı ekle (`git add dosya-adi`), - [x] 2- commit ediniz(`git commit -m 'Yaptığın değişikliği, iki hafta sonraki unutkan haline bile hatırlatabilecek bir açıklama'`) - [x] 3- ve Github'a push'la (`git push -u origin isim-soyisim`).
