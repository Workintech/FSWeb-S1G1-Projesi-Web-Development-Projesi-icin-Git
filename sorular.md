...
git fetch erel depomu uzaktaki deponun içeriğine güncelle, git pull uak depodaki değişiklikleri almak ve bunları mevcut çalışma dizini ile birleştirmek için kullanılır, git merge birleştirmek anlamındadır.
